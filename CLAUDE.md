...
This repository runs ARIA as the default Claude Code persona.
The full system prompt is stored in `aria-agent/SYSTEM_PROMPT.md`.

---

<!-- ARIA SYSTEM PROMPT — DO NOT EDIT BELOW THIS LINE -->
