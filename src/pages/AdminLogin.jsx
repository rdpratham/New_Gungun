        ...
        <div className="w-full max-w-md">
          <div className="card">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400 mt-1 text-sm">Sign in to manage attendance records</p>
            </div>
            ...
            <p className="text-center text-slate-500 text-sm mt-6">
              Employee?{' '}
              <a href="/new_gungun/login" className="text-electric-400 hover:text-electric-500 transition-colors">
